    ...
    <>
      ...
      <div className="container mx-auto mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-between flex-wrap p-8 bg-[#DDDDDD]">
          ...
          <button
            type="button"
            className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-2 px-4 rounded-full text-lg w-full mt-4"
